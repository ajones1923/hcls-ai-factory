...
| `AUTO_LLM_MODEL` | str | claude-sonnet-5 | LLM model identifier |
...
### 14.5 the AI platform Integration

The HCLS AI Factory is being prepared for deployment on the AI platform, which provides:

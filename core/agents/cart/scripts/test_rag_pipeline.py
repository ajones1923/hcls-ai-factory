...
Requires:
  ...
  - ANTHROPIC_API_KEY set (or in core/engines/precision-intelligence/.env)
...
if not os.environ.get("ANTHROPIC_API_KEY"):
    env_path = Path(os.environ.get("CART_RAG_PIPELINE_ROOT", "/app/core/engines/precision-intelligence")) / ".env"
    if env_path.exists():

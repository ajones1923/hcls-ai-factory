...
### 22.1 the AI platform Integration

The CAR-T Intelligence Agent is designed for future integration with the intelligent agent:
- `CARTIntelligenceAgent.run()` maps to the agent engine entry point

...
async def lifespan(app: FastAPI):
    ...
    llm_client = build_service_llm(
        settings.LLM_MODEL, service="clinical-trial", default_system=_TRIAL_SYSTEM_PROMPT)
...
try:  # pragma: no cover - platform lib is optional at import time
    ...
    install_api_key_auth(app, service="clinical-trial")
    install_governance(app, service="clinical-trial", capability_id="clinical-trial-intelligence-agent")

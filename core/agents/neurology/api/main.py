...
async def lifespan(app: FastAPI):
    ...
    llm_client = build_service_llm(
        settings.LLM_MODEL, service="neurology", default_system=_NEURO_SYSTEM_PROMPT)
...
try:  # pragma: no cover - platform lib is optional at import time
    ...
    install_api_key_auth(app, service="neurology")
    install_governance(app, service="neurology", capability_id="neurology-intelligence-agent")

...
## 23. Cross-Agent Integration

### 23.1 Direct Cross-Agent Endpoints (4 Agents)

| Agent | Port | URL | Trigger Condition |
|---|---|---|---|
| Oncology Agent | 8527 | localhost:8527 | Chemotherapy PGx: DPYD fluoropyrimidine, UGT1A1 irinotecan, TPMT/NUDT15 thiopurine |
| Cardiology Agent | 8126 | localhost:8126 | Anticoagulant PGx: CYP2C9/VKORC1 warfarin, CYP2C19 clopidogrel |
| Neurology Agent | -- | -- | Antiepileptic PGx: CYP2C9 phenytoin, HLA-B*15:02 carbamazepine SJS/TEN |
| Clinical Trial Agent | 8538 | localhost:8538 | PGx-stratified trial eligibility, metabolizer phenotype for enrollment |

All queries use HTTP REST with 30-second timeout and graceful degradation.

### 23.2 Pediatric Oncology PGx

| Gene/Pair | Drug | Pediatric Context | PGx Action |
|---|---|---|---|
| TPMT/NUDT15 | 6-Mercaptopurine | ALL maintenance therapy | PM requires 90% dose reduction; mandatory pre-treatment genotyping |
| CYP3A5 | Vincristine | ALL induction/consolidation | CYP3A5 expressers (*1 carriers) show increased clearance |
| UGT1A1 | Irinotecan | Pediatric solid tumors | UGT1A1*28 homozygotes: 30% dose reduction for severe toxicity prevention |
| MTHFR | Methotrexate | High-dose ALL protocols | C677T/A1298C variants modulate toxicity risk |

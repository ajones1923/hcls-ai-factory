...
async def lifespan(app: FastAPI):
    ...
    llm_client = build_service_llm(
        settings.LLM_MODEL, service="rare-disease-diagnostic", default_system=_RD_SYSTEM_PROMPT)
...
try:  # pragma: no cover - platform lib is optional at import time
    ...
    install_api_key_auth(app, service="rare-disease-diagnostic")
    install_governance(app, service="rare-disease-diagnostic", capability_id="rare-disease-diagnostic-agent")

...
_DEFAULT_RAG_TARGETS_DIR = _HCLS_ROOT / "core/engines/precision-intelligence" / "data" / "targets"
    ...
    def __init__(self, rag_data_dir: Path = None):
        ...
        Args:
            rag_data_dir: Path to RAG Chat data directory containing targets.
                          Defaults to sibling core/engines/precision-intelligence/data/targets directory.

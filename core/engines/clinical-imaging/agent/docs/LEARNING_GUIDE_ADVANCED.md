...
The Imaging Engine uses `IVF_FLAT` (Inverted File with Flat quantization) defined in `src/vector_collections.py`:
...
| `IMAGING_LLM_MODEL` | `claude-sonnet-5` | LLM model name |

...
12 expansion maps (with extended pathology, body region, and guideline
entries) that augment user queries with synonyms, abbreviations, and
related technical terms to improve Milvus vector search recall.
"""
...
BODY_REGION_EXPANSION = {
    ...
    "shoulder": {"glenohumeral", "rotator cuff", "labrum", "acromioclavicular", "supraspinatus", "infraspinatus", "subscapularis", "shoulder joint"},
    "musculoskeletal": {"msk", "orthopedic", "bone", "joint", "tendon", "ligament", "muscle", "cartilage", "meniscus"},
}
...
PATHOLOGY_EXPANSION = {
    ...
    "emphysema": {"copd", "air trapping", "bullous emphysema", "centrilobular", "panlobular", "paraseptal", "low attenuation area", "laa"},
    "lymphadenopathy": {"enlarged lymph node", "nodal enlargement", "reactive nodes", "metastatic nodes", "hilar adenopathy", "mediastinal adenopathy", "bulky disease", "staging"},
    "breast_mass": {"breast lesion", "breast lump", "breast tumor", "breast cancer", "mammographic mass", "breast density", "spiculated mass", "bi-rads"},
    "thyroid_nodule": {"thyroid lesion", "thyroid mass", "thyroid cancer", "ti-rads", "tirads", "fna", "bethesda", "thyroid ultrasound"},
    "pancreatic_mass": {"pancreatic tumor", "pancreatic cancer", "pdac", "pancreatic lesion", "double duct sign", "whipple", "ipmn", "pancreatic cyst"},
    "bowel_obstruction": {"sbo", "small bowel obstruction", "ileus", "bowel dilation", "transition point", "adhesive obstruction", "closed loop", "large bowel obstruction"},
    "appendicitis": {"appendiceal inflammation", "appendix", "rlq pain", "periappendiceal", "appendicolith", "perforated appendix", "fat stranding"},
    "coronary_calcification": {"calcium score", "agatston", "agatston score", "cac", "coronary calcium", "calcified plaque", "coronary artery disease", "cac score"},
    "osteoporosis": {"osteopenia", "bone density", "dexa", "bone mineral density", "t-score", "compression fracture", "vertebral fracture", "fragility fracture"},
    "degenerative_disc": {"disc degeneration", "disc herniation", "ddd", "pfirrmann", "spinal stenosis", "disc bulge", "disc protrusion", "disc extrusion", "facet arthropathy"},
}
...
GUIDELINE_EXPANSION = {
    ...
    "bosniak": {"bosniak classification", "renal cyst classification", "cystic renal mass", "bosniak category", "bosniak 2019"},
    "pfirrmann": {"pfirrmann grade", "pfirrmann classification", "disc grading", "disc degeneration grade", "intervertebral disc grade"},
}

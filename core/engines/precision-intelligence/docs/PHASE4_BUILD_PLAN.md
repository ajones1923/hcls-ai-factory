...
- [ ] VCF file exists: `core/engines/genomic-foundation/data/output/HG002.genome.vcf.gz`
...
VCF_INPUT_PATH=core/engines/genomic-foundation/data/output/HG002.genome.vcf.gz
```

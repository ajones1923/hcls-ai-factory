...
async def lifespan(app: FastAPI):
    ...
    llm_client = build_service_llm(
        settings.LLM_MODEL, service="cardiology", default_system=_CARDIO_SYSTEM_PROMPT)
...
try:  # pragma: no cover - platform lib is optional at import time
    ...
    install_api_key_auth(app, service="cardiology")
    install_governance(app, service="cardiology", capability_id="cardiology-intelligence-agent")

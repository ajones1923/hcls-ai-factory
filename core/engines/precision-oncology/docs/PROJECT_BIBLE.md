...
| # | Agent | Domain |
|---|-------|--------|
| 1 | **Precision Oncology Agent** (this agent) | Molecular tumor board decision support |
...
the `/integrated-assessment` endpoint: CAR-T, Biomarker, Clinical Trial,
Cardiology, Neurology, PGx, Imaging, and Single-Cell agents.

### Pediatric Oncology as Primary Use Case

Pediatric oncology is a primary use case, with support for 11 pediatric
cancer types (ALL, neuroblastoma, medulloblastoma, rhabdomyosarcoma, Wilms
tumor, Ewing sarcoma, hepatoblastoma, retinoblastoma, pediatric AML,
pediatric glioma, osteosarcoma), BSA-scaled dosing, and MYCN amplification
as a critical prognostic biomarker for neuroblastoma risk stratification.
...
| LLM_MODEL                      | str    | claude-sonnet-5           | LLM model identifier                     |

...
Claude LLM (claude-sonnet-5 by default) and returns the generated
answer.
...
[OncoRAGEngine.synthesize()]
    ...
    |   -> Claude (claude-sonnet-5) -> answer with citations
    |
    v
[Formatted Response]
...
ONCO_LLM_MODEL            default: claude-sonnet-5
...
"anthropic") and `ONCO_LLM_MODEL` (default: claude-sonnet-5). To add a
...
*This document reflects the codebase as of March 2026, version 0.1.0.*

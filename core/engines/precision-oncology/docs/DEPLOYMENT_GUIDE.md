...
# === LLM ===
ONCO_LLM_MODEL=claude-sonnet-5
...
| `ONCO_LLM_MODEL` | `claude-sonnet-5` | Claude model to use for RAG answer generation. |
...
| `ONCO_LLM_MODEL` | `claude-sonnet-5` | Claude model name |

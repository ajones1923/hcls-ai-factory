...
**NVIDIA Parabricks** is software that uses a GPU to do both alignment and variant calling. On the NVIDIA DGX Spark (a desktop computer that costs $4,699), Parabricks completes the entire process in about **1 hour** instead of 1-2 days. That's a 10-20× speedup!

...
Across the top, a header — "Measured, Not Asserted", subtitle "The TSC Intelligence Engine, graded against known ground truth".
...
Along the bottom, a prominent gold-bordered band given real visual weight, headed with the words "What these numbers mean — and don't." and reading beneath: "These results show the engine's logic faithfully recovers signal from synthetic data with known answers (construct validity). They do NOT prove performance on real patients (clinical validity). The real test is running it on actual specimens — exactly the next step."
Along the very bottom, a thin footer strip reading: "Live at /eval · graded against a 50-patient synthetic cohort · Apache 2.0 · Engine 7 of the HCLS AI Factory · SYNTHETIC demonstration data · decision support · not FDA-cleared."

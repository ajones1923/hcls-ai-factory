...
description: The flagship disease program — the whole HCLS AI Factory converging on one child, in one governed afternoon. Decision support, not diagnosis; gene therapy is preclinical.
---
...
<video class="cap-video" controls preload="none" playsinline poster="../assets/infographics/tsc-flagship.png">
  <source src="../assets/videos/tsc-usecase.mp4" type="video/mp4">

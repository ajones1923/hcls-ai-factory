...
*This document serves as the complete implementation specification for the Clinical Imaging Engine. For architecture details see the Design Document. For demo walkthrough see the Demo Guide.*

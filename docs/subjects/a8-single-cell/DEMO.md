# Single-Cell Intelligence — Demo Guide

**Demo key:** `A8` · full specification in
...
Each run writes `demo/transcripts/A8.txt`. Diff it after a change — a silent regression

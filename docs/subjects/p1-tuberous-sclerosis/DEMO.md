# Tuberous Sclerosis Complex — Demo Guide

**Demo key:** `P1` · full specification in
...
Each run writes `demo/transcripts/P1.txt`. Diff it after a change — a silent regression

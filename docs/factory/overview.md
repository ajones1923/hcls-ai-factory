...
- **[Frontier Models](frontier-models/index.md)** — heavy or partner-gated models the factory connects
  to on demand via elastic burst (**Anthropic's Claude**, **NVIDIA BioNeMo**, and **Chai Discovery**,
  plus the roadmap frontier), each with an honest status.
